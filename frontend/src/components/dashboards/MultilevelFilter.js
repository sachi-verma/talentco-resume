        ...
        <Container>  
          ...
          <Navbar.Collapse id="responsive-navbar-nav">  
            ...
            <Nav variant="pills" activeKey="2" className="myNav nav-pills">
              <Nav.Link eventKey="1" href="/form" style={{margin: '5px', color: '#101e45'}}>Resume Form</Nav.Link>  
              <Nav.Link className="nav-link" eventKey="2" href="/filter" style={{margin: '5px', backgroundColor: "#101e45"}}>View Resumes</Nav.Link>  
              <Nav.Link eventKey="3" href="/upload" style={{margin: '5px', color: '#101e45'}}>Upload Resumes</Nav.Link>
