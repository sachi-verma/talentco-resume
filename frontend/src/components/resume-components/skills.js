  ...
  return (
    <Row className="justify-content-center mt-2">
      ...
      <Modal show={show} onHide={handleClose} centered backdrop="static">
        <Modal.Header>
          <Modal.Title style={{fontSize: 30}}>Skills</Modal.Title>
        ...
        <Modal.Body>
          <Form noValidate validated={validated} className="d-flex align-item-start mb-2" onSubmit={handleSkills}>
            <Form.Group className="">
              <Form.Control required style={{fontSize: 15}} type="text" size="sm" placeholder="Enter Skill" value={input} onChange={handleInput} />
            </Form.Group>
            <button type="submit" style={{fontSize: 12, marginLeft: "10px"}} className="rounded edit m-0 mx-2" class="btn btn-danger">
              Add Skill
            </button>
          </Form>
          <hr></hr>
