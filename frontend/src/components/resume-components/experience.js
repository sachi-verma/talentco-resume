  ...
  return (
    <Row className="justify-content-center mt-2">
      ...
      <Modal show={show} onHide={handleClose} centered scrollable={true} backdrop="static">
        <Modal.Header>
          <Modal.Title style={{fontSize: 30}}>Experience</Modal.Title>
        ...
        <Modal.Body>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Control required type="text" style={{fontSize: 15}} placeholder="Ex: React Developer" name="title" value={form.title} onChange={handleForm} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize: 15}}>Company Name</Form.Label>
              <Form.Control required style={{fontSize: 15}} type="text" size="sm" placeholder="Ex: Amazon" name="company" value={form.company} onChange={handleForm} />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control required style={{fontSize: 15}} type="text" size="sm" placeholder="Ex: Pune, India" name="location" value={form.location} onChange={handleForm} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize: 15}}>Description</Form.Label>
              <Form.Control required style={{fontSize: 15}} type="text" size="sm" placeholder="Ex: Worked as a Front-End Developer" name="description" value={form.description} onChange={handleForm} />
            </Form.Group>
