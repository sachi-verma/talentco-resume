  ...
  return (
    <Row className="justify-content-center mt-2">
      ...
      <Modal show={show} onHide={handleClose} centered scrollable={true} backdrop="static">
        <Modal.Header>
          <Modal.Title style={{fontSize: 30}}>Education</Modal.Title>
        ...
        <Modal.Body>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize: 15}}>Institute</Form.Label>
              <Form.Control required style={{fontSize: 15}} type="text" name="institute" size="sm" placeholder="Ex: Government Engineering College" value={form.institute} onChange={handleForm} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize: 15}}>Degree</Form.Label>
              <Form.Control required style={{fontSize: 15}} type="text" name="degree" size="sm" placeholder="Ex: Bachelor of Engineering" value={form.degree} onChange={handleForm} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize: 15}}>Field of study</Form.Label>
              <Form.Control required style={{fontSize: 15}} type="text" name="fieldOfStudy" size="sm" placeholder="Ex: Computer Engineering" value={form.fieldOfStudy} onChange={handleForm} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Row>
                <Col>
                  <Row>
                    <Form.Label style={{fontSize: 15}}>Start - Year</Form.Label>
                  </Row>
                  <Row>
                    <Col>
                ...
                <Col>
                  <Row>
                    ...
                    <Col>
                      <Row>
                        <Form.Label style={{fontSize: 15}}>End - Year</Form.Label>
                      </Row>
                      <Row>
                        <Col>
            ...
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize: 15}}>Grade</Form.Label>
              <Form.Control required style={{fontSize: 15}} type="text" name="grade" size="sm" placeholder="Ex: 8.5/10 CGPA" value={form.grade} onChange={handleForm} />
            </Form.Group>
