...
export const managePersonal = (personal) => {
    return (dispatch) => {
        dispatch({
            type: "MANAGE_PERSONAL",
            payload: personal
        })
    }
}
...
export const addCertification = (form) => {
    return (dispatch) => {
        dispatch({
...
export const editCertification = (form) => {
    return (dispatch) => {
        dispatch({
...
export const removeCertification = (index) => {
    return (dispatch) => {
        dispatch({
